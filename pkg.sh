...
mv $pwd/build/index $pwd/build/zephyr-clone-testcycles_macos
...
mv $pwd/build/index $pwd/build/zephyr-clone-testcycles_linux

cp $pwd/README.md $pwd/build/README.md